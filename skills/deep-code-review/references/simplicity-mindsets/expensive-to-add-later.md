...
The simplicity lens pushes toward less. This mindset identifies the exceptions where "add it now" beats "add it later" — flag a PR for *missing* a PAGNI, not just for over-building.
